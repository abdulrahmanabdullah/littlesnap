    ...
    override fun onClick(viewId: View) {
        when (viewId.id) {
            R.id.stillShot_imgView -> {
                takePicture()
                //todo :: move save picture this action to somewhere else .
                var str = SimpleDateFormat("yyMMdd-HH:mm:ss").format(Date())
                mFile = File(activity!!.getExternalFilesDir(null), str+PIC_FILE_NAME)
            }
        ...
        try {
            ...
            val captureCallBack = object : CameraCaptureSession.CaptureCallback() {
                ...
                override fun onCaptureCompleted(
                    ...
                    activity!!.showToast("Take picture and saved .. ")
                    unLockFocus()
                }
            }
