...
class Camera2Fragment : BaseFragment(), View.OnClickListener {
    ...
    //Callback functions region
    // Camera device call back when camera change mState
...
//        try {
//            mBackgroundHandler??.post(ImageSaver(it.acquireLatestImage(), mFile))
////            Log.i(TAG,"image listener ${it.acquireNextImage().timestamp}")
//        } catch (e: NullPointerException) {
//            Log.d(TAG, " onImageAvailable throw this exception ${e.message}")
//        }
    }
